...
export const comingSoonFeatures: ComingSoonFeature[] = [
  ...
  },
  {
    ...
    description: 'Erfahren sie von kommenden Workshops und Events zur KLARE-Methode.',
    icon: '📅',
  },
  {
    title: 'Ressourcen-Bibliothek',
    description: 'Zugang zu Artikeln, Übungen und Tools für ihre persönlichen Veränderungen.',
    icon: '📚',
  },
];

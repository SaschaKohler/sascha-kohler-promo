    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: colorScheme.text }}>
            Die <span style={{ color: colorScheme.primary }}>Kongruenz-Methode</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-4">
            Die KLARE Kongruenz-Methode: In 5 Schritten zur vollständigen Übereinstimmung in allen
            Lebensbereichen und zur natürlichen Manifestation deiner Ziele.
          </p>
          <p
            className="text-md text-gray-600 max-w-2xl mx-auto italic border-l-4 pl-4 py-2"
            style={{ borderColor: colorScheme.accent }}
          >
            Die Kongruenz-Methode ist ein ganzheitlicher Ansatz für die persönliche Transformation,
            der den Menschen in seiner Einzigartigkeit und Vielschichtigkeit betrachtet – bewusst
            abgegrenzt von unternehmensorientierten Kongruenz-Modellen, die Menschen als Ressourcen
            oder Systeme behandeln.
          </p>
        </div>
        ...
        <div className="mb-12">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-x-3 gap-y-2 mb-6">
              {klareSteps.map(step => (
                <div key={step.id} className="flex items-center">
                  <span className="font-bold text-lg mr-1" style={{ color: step.color }}>
                    {step.letter}
                  </span>
                  <span className="text-gray-700">{step.title}</span>
                  {step.id < klareSteps.length && (
                    <span className="text-gray-400 ml-1 mr-0 hidden sm:inline">•</span>
                  )}
                </div>
              ))}
            </div>
            ...
            >
              ...
              <p className="text-gray-700 mb-4">{klareSteps[activeStep].description}</p>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Möchtest du herausfinden, wie die KLARE Kongruenz-Methode dir helfen kann, deinen
            eigenen Weg zur persönlichen Transformation zu gehen?
          </p>
          <button

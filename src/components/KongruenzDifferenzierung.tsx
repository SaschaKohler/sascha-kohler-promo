...
const KongruenzDifferenzierung: React.FC<KongruenzDifferenzierungProps> = ({ colorScheme }) => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold" style={{ color: colorScheme.text }}>
              Wichtige <span style={{ color: colorScheme.primary }}>Differenzierung</span>
            </h2>
          </div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Die Kongruenz-Methode ist ein speziell für <strong>Menschen</strong> entwickelter
            Ansatz, der sich bewusst von unternehmensorientierten Kongruenz-Modellen abgrenzt.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="p-6 bg-gray-800 text-white flex items-center">
              ...
              <h3 className="text-xl font-semibold">Unternehmensorientierte Kongruenz-Modelle</h3>
            </div>
            <div className="p-6">
        ...
        <div className="max-w-3xl mx-auto mt-12 bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-700 mb-4">
            Die Kongruenz-Methode entstand aus der Erkenntnis, dass etablierte Kongruenz-Modelle aus
            der Unternehmensführung nicht auf den Menschen in seiner Komplexität übertragbar sind.
            Menschen sind keine Systeme oder Ressourcen, die standardisiert optimiert werden können.
          </p>
          <p className="text-gray-700">
            Stattdessen braucht es einen Ansatz, der den Menschen in seiner vollen Menschlichkeit
            respektiert und eine authentische, individuelle Entfaltung ermöglicht. Die
            Kongruenz-Methode bietet genau das: einen Weg zur Kongruenz, der dich nicht als System,

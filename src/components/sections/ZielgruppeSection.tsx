  ...
  const targetGroups = [
    {
      ...
      ageRange: "25-35",
      tagline:
        "Zwischen Erwartungsdruck und dem Wunsch nach authentischer Selbstverwirklichung",
      icon: Compass,
      description:
      ...
      benefits: [
        {
          ...
          description:
            "Entwicklung eines inneren Kompasses für authentische Lebensentscheidungen",
        },
        {
          icon: Zap,
          title: "Proaktive Lebensgestaltung",
          description:
            "Frühzeitige Entwicklung von Kongruenz-Strategien statt später Korrektur",
        },
        {
          icon: MessageCircle,
    ...
    },
    {
      ...
      ageRange: "35-50",
      tagline:
        "Äußerlich erfolgreich, innerlich auf der Suche nach mehr Kongruenz",
      icon: Briefcase,
      description:
      ...
      benefits: [
        {
          ...
          description:
            "Entwicklung einer neuen, sinnstiftenden Identität jenseits des Berufs",
        },
        {
          icon: Clock,
          title: "Bewusste Zeitgestaltung",
          description:
            "Strategien zur kongruenten Nutzung der neugewonnenen Freiheit",
        },
        {
          icon: Award,
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Ein spezifischer Ansatz für Menschen in verschiedenen Lebensphasen,
            die bereit sind, ihr volles Potenzial zu entfalten.
          </p>
            ...
            <div className="relative z-10">
              ...
              >
                <p className="text-gray-700 italic">
                  "Die KLARE Kongruenz-Methode ist für Menschen entwickelt, die
                  bereit sind, die Verantwortung für ihre Transformation zu
                  übernehmen. Sie bietet keine schnellen Lösungen, sondern einen
                  nachhaltigen Weg zu einem Leben, in dem innere Überzeugungen
                  und äußeres Handeln vollständig kongruent sind."
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-12 max-w-4xl mx-auto">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 italic">
              In jeder Lebensphase bietet die KLARE Kongruenz-Methode einen
              angepassten Weg, um innere Werte mit äußerem Handeln in Einklang
              zu bringen.
            </p>
          </div>
        </div>

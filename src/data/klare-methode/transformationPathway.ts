...
// Von-Zu Transformation Pathway
export const transformationPathway: TransformationPathway[] = [
  {
    from: 'Innere Widersprüche zwischen Denken, Fühlen und Handeln',
    to: 'Vollständige Kongruenz und Ausrichtung',
  },
  {
  ...
  },
  {
    ...
    to: 'Authentische Entfaltung des eigenen Potentials',
  },
  {

    ...
    <div className="w-full max-w-6xl mx-auto p-4">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
          Bewerten Sie verschiedene Bereiche Ihres Lebens, um Klarheit über Ihre aktuelle Situation
          zu gewinnen und Ihre gewünschten Ziele zu definieren.
        </p>
      </div>
            ...
            <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
              ...
              <polygon
                points={lifeAreas
                  .map((area, index) => {
                    const angle = calculateAngle(index, lifeAreas.length);
                    const point = polarToCartesian((radius * area.currentValue) / maxValue, angle);
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm">
                        ...
                        : Hier besteht eine große Lücke zwischen Ist ({area.currentValue}) und Soll
                        ({area.desiredValue}).
                      </p>
                    </div>
                  </div>
